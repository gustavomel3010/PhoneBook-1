...
namespace appPhone.ViewModels
{
    ...
    public class PhoneBookViewModel : BaseViewModel 
    {
        ...
        private ObservableCollection<Phone> phones;  //atributo con minuscula y propiedad de la clase con mayuscula
        #endregion
       ...
       public  ObservableCollection<Phone> Phones
        ...
        private async void LoadPhones()
        {
            ...
            {
                await Application.Current.MainPage.DisplayAlert( //Display alert 
